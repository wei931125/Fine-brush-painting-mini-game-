...
const stage3Data = [
    ...
    {
        step: 4, title: "【步驟 4：分染】", canvasText: "[畫布：準備上色的牡丹]", image: "第三情境-第四關.jpg",
        desc: "畫面上出現兩支筆。請操作「一支色筆蘸色、一支水筆推開」，形成由濃至淡漸層陰影，用於第一層陰影立體塑造。",
        actions: [{ text: "進行分染", next: 5 }]
    },
    {
        step: 5, title: "【步驟 5：統染】", canvasText: "[畫布：具備局部立體感的牡丹]", image: "第三情境-第五關.jpg",
        desc: "局部立體感出來後，請執行「統染」，將剛剛畫好的各個部分統一明暗。",
        actions: [{ text: "進行統染", next: 6 }]
    },
    {
        step: 6, title: "【步驟 6：罩染】", canvasText: "[畫布：明暗協調的牡丹]", image: "第三情境-第六關.jpg",
        desc: "在已染底色上，重覆渲染礦物顏料進行「罩染」，藉此增強色彩厚度與凹凸感。",
        actions: [{ text: "進行罩染", next: 7 }]
    },
    {
        step: 7, title: "【步驟 7：三礬九染 (防呆挑戰)】", canvasText: "[畫布：開始進行三礬九染]", image: "第三情境-第七關.jpg",
        desc: "這是一個多次上色＋多次用膠礬水固色的反覆過程。請嚴格依照順序點擊：【染 2～3 次】→【等乾】→【上一層薄膠礬水】→【等乾】。",
    },
    {
        step: 8, title: "【步驟 8：復勒】", canvasText: "[畫布：色彩厚實的牡丹]", image: "第三情境-第八關.jpg",
        desc: "因為厚重的顏料蓋住了最初的線條，請使用小號毛筆進行「復勒」，也就是設色後重勾邊緣。",
        actions: [{ text: "進行復勒", next: 9 }]
    },
    {
        step: 9, title: "【步驟 9：立粉】", canvasText: "[畫布：邊緣清晰的牡丹]", image: "第三情境-第九關.jpg",
        desc: "請點擊牡丹花的中心，使用「立粉」技法，點染花蕊使其產生立體感。",
        actions: [{ text: "進行立粉", next: 10 }]
    },
    {
        step: 10, title: "【步驟 10：烘染】", canvasText: "[畫布：花蕊立體的牡丹]", image: "第三情境-第十關.jpg",
